						...
						<div class="col-lg-12">
							...
							<div class="form-group">
								<div id="total-record" class="col-lg-8 text-left">
									▶오늘 회원 수 : ${page.totalRecord }명&nbsp; &nbsp; ▶현재 페이지 ( <span
										id=page-location>${page.nowPage+1 } / ${page.totalPage}
										페이지</span>)
								</div>
								<p class="col-lg-4 text-right">오늘의 총액 : ${totalPrice} 원</p>
							...
							<div class="form-group">
										...
										<tbody>
											...
											<c:forEach begin="${page.beginPerPage }"
												...
												<c:if test="${not doneLoop }">
													...
													<c:choose>
														<c:when test="${ visitList[i].price >= 0 }">
															<tr>
								...
								<div class="col-lg-2 col-lg-offset-10"  id="btn-bottom">
